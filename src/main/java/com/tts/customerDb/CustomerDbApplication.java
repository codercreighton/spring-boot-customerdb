...
import com.tts.customerDb.customer.Customer;
import com.tts.customerDb.customer.CustomerRepository;
...
public class CustomerDbApplication {
	...
	private static final Logger log = (Logger) LoggerFactory.getLogger(CustomerDbApplication.class);
